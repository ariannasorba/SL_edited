...
%\documentclass[12pt,phd,a4paper,twoside]{thesis_jon}
...
\input{FloatSettings} % For things like figures and tables - modify because both with and without are not great at the moment
...
\include{Chapters/cass_chapter}
%\include{Chapters/compressibility_chapter}
%\include{Chapters/equinox_chapter}
%\include{Chapters/LT_chapter}
